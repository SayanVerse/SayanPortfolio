export function AnimatedLogo() {
  return (
    <div className="relative w-16 h-16 mx-auto perspective-1000">
      ...
      <div
        className="absolute inset-1 rounded-full border-2 animate-spin shadow-lg"
        style={{
          animationDuration: "2s",
          animationDirection: "reverse",
          borderImage: "linear-gradient(45deg, #3b82f6, #8b5cf6, #ec4899) 1",
          boxShadow:
            "0 0 20px rgba(59, 130, 246, 0.8), inset 0 0 20px rgba(139, 92, 246, 0.4)",
        }}
      ></div>

      {/* Inner pulsing core with scale animation */}
      <div
        className="absolute inset-3 rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-pulse"
        style={{
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute w-2.5 h-2.5 animate-spin"
          style={{
        ...
        <div
          className="absolute w-1.5 h-1.5 animate-spin"
          style={{
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="absolute top-0 left-1/2 w-0.5 h-3 bg-gradient-to-t from-blue-500 to-transparent"
          style={{
            animation: "sparkFade 2s ease-in-out infinite",
            animationDelay: "0s",
          }}
        ></div>
        <div
          className="absolute bottom-0 right-1/4 w-0.5 h-2 bg-gradient-to-b from-purple-500 to-transparent"
          style={{
            animation: "sparkFade 2s ease-in-out infinite",
            animationDelay: "0.5s",
          }}
        ></div>
        <div
          className="absolute top-1/4 right-0 h-0.5 w-3 bg-gradient-to-r from-pink-500 to-transparent"
          style={{
            animation: "sparkFade 2s ease-in-out infinite",
            animationDelay: "1s",
          }}
        ></div>
        <div
          className="absolute bottom-1/3 left-0 h-0.5 w-2 bg-gradient-to-l from-cyan-500 to-transparent"
          style={{
            animation: "sparkFade 2s ease-in-out infinite",
            animationDelay: "1.5s",
          }}
